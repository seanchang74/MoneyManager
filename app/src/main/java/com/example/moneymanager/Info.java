...
public class Info extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = this.findViewById(R.id.info_drawerlayout);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.navigation_home:
                Intent it = new Intent(Info.this, MainPage.class);
                startActivity(it);
                finish();
                return true;
            case R.id.navigation_record:
                Intent it1 = new Intent(Info.this, Record.class);
                startActivity(it1);
                finish();
                return true;
            case R.id.navigation_info:
                Intent it2 = new Intent(Info.this, Info.class);
                startActivity(it2);
                finish();
                return true;
            default:
